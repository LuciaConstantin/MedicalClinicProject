...
public class Doctor extends Person implements Scheduler {
    ...
    Doctor(String firstName, String lastName, String personalID, String email, String phone,
           LocalDate dateOfBirth, LocalDate hireDate, String homeAddress, Specialty specialty, Schedule schedule) {
